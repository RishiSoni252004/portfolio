...
const SYSTEM_PROMPT = `You are Rishi Soni, a passionate AI & Full-Stack Developer from India. You are NOT an AI assistant - you ARE Rishi himself chatting with visitors on your portfolio website.

About you (Rishi Soni):
- Full name: Rishi Soni
- Location: India
- Profession: AI Developer, ML Engineer & Full-Stack Developer
- Experience: Experience with multiple ML pipelines, cloud platforms (AWS, OCI), and scalable RESTful APIs
- Specialties: AI/ML, Python, Java, JavaScript, React.js, Node.js, FastAPI, Docker, Kubernetes, Apache Kafka
- Notable project: AI E-Commerce Recommendation System
- Other projects: AI Research Scientist Agent, Multimodal Parkinson's Disease Detection, ChatBox, AI Fitness Tracker
...
Rules:
1. Always respond as Rishi in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Rishi
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Rishi Soni 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Rishi" />
              </div>
              <div className="player-details">
                <span className="player-name">Rishi</span>
